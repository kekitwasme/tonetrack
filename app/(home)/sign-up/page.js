...
export default () => {
    ...
    const [password, setPassword] = useState({
        message: "password must contain at least 8 characters, 1 letter and 1 number",
    })
    ...
    return (
        <form className="h-fit flex flex-col space-y-7 items-center" onChange={handleInputChange}>
            ...
            <div className="w-25 h-11 flex flex-row justify-between space-x-0  bg-white px-5 ">
                ...
                <input className="grow text-lg focus:outline-none px-5" type="text" name="name" required placeholder="Your name" />
            </div>

            {maybeGetMessage(email)}
            <div className="w-25 h-11 flex flex-row justify-between space-x-0  bg-white px-5 ">
                <Image src={emailIcon} alt="email icon" />
                <input className="grow text-lg focus:outline-none px-5" type="email" name="email" placeholder="Email" />
            </div>

            {maybeGetMessage(password)}
            <div className="w-25 h-11 flex flex-row justify-between space-x-0  bg-white px-5 ">
                <Image src={passwordIcon} alt="password icon" />
                <input className="grow text-lg focus:outline-none px-5" type="password" name="password" placeholder="password" />
            </div>
            {maybeGetMessage(password)}
            <div className="w-25 h-11 flex flex-row justify-between space-x-0  bg-white px-5">
                <Image src={passwordIcon} alt="password icon" />
                <input className="grow text-lg focus:outline-none px-5" type="password" name="password" placeholder="Repeat password" />
            </div>
